...
fn demo_mbus_dual_path() {
    ...
    let records = vec![
        ...
        MBusRecord {
            ...
            function_medium: "",
            quantity: mbus_core::payload::text::QuantityText::Static("Energy"),
            drh: Default::default(),
            data: Default::default(),
            more_records_follow: false,
            applied_quirks: Default::default(),
        ...
        MBusRecord {
            ...
            function_medium: "",
            quantity: mbus_core::payload::text::QuantityText::Static("Temperature"),
            drh: Default::default(),
            data: Default::default(),
            more_records_follow: false,
            applied_quirks: Default::default(),
        ...
        MBusRecord {
            ...
            unit: mbus_core::payload::text::UnitText::Static("°C"),
            function_medium: "",
            quantity: mbus_core::payload::text::QuantityText::Static("Temperature Sensor 2"),
            drh: Default::default(),
            data: Default::default(),
            more_records_follow: false,
            applied_quirks: Default::default(),
