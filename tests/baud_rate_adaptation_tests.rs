use mbus_rs::mbus::serial::{CollisionConfig, CollisionStatistics, MBusBaudRate, SerialConfig};
...
fn test_inter_frame_delay() {
    ...
    assert!(
        MBusBaudRate::Baud9600.inter_frame_delay() > MBusBaudRate::Baud38400.inter_frame_delay()
    );
